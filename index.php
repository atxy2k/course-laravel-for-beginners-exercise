...
<body>
  ...
  <div class="sidebar-left">
    ...
    <div class="sidebar-content">
      <div class="sidebar-logo">
        <a href="index.html"><img src="<?= '/template/assets/images/logo.svg' ?>" alt="Logo" /></a>
      </div>
  ...
  <section class="about-area about-five">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-12">
          <?php include './partials/our_stories.php' ?>
        </div>
      </div>
    </div>
    <!-- container -->
  ...
  <?php include './partials/our_best_services.php'; ?>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="<?= '/template/assets/images/blog/1.jpg' ?>" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="<?= '/template/assets/images/blog/b6.jpg' ?>" alt="Author" />
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="<?= '/template/assets/images/blog/2.jpg' ?>" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="<?= '/template/assets/images/blog/b6.jpg' ?>" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="<?= '/template/assets/images/blog/3.jpg' ?>" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="<?= '/template/assets/images/blog/b6.jpg' ?>" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        <div class="col-lg-8 offset-lg-2 col-12">
          <div class="clients-logos">
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/graygrids.svg' ?>" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/uideck.svg' ?>" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/ayroui.svg' ?>" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/lineicons.svg' ?>" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/tailwindtemplates.svg' ?>" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="<?= '/template/assets/images/client-logo/ecomhtml.svg' ?>" alt="Brand Logo Images" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="footer-widget f-about">
                <div class="logo">
                  <a href="index.html">
                    <img src="<?= '/template/assets/images/logo.svg' ?>" alt="#" class="img-fluid" />
                  </a>
                </div>
                <p>
